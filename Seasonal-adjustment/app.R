        ...
        mainPanel(
            tabsetPanel(
                tabPanel("Introduction", 
                         ...
                         img(src = "https://github.com/nelson-io/seasonal_adjustment_shiny/raw/master/table.PNG", style="display: block; margin-left: auto; margin-right: auto;"),
                         ...
                         p(""),
                         p(""),
                         p(a("Here", href= "https://github.com/nelson-io/seasonal_adjustment_shiny/raw/master/sample_data_emae.xlsx"), " is a sample .xlsx file to try the app!")
                ),
